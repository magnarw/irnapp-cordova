...
.factory('$localstorage', ['$window', function($window) {
  return {
	...
	this.getPreyTimesForDay = function(day){
		...
		//var skygge = window.localStorage['preysettings.skygge'] || 1;
    ...
    this.getPreyTimesForMonth = function(start,end){
        ...
        for(var i = start;i<end;i++){
            var prey = this.preytimes.Oslo.Row[i];
            var day = [
            { title: 'Fajr', time :cleanTime(prey._C)},
            { title: 'Soloppgang',time :cleanTime(prey._D)},
            { title: 'Duhr', time : cleanTime(prey._F)},
            { title: 'Asr', time : cleanTime(prey._G)},
            { title: 'Maghrib', time : cleanTime(prey._H)},
            { title: 'Isha', time : cleanTime(prey._I)},
